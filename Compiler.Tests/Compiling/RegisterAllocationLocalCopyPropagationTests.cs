namespace Compiler.Tests.Compiling
{
    ...
    public class RegisterAllocationLocalCopyPropagationTests : CompilationTestBase
    {
        public RegisterAllocationLocalCopyPropagationTests()
            : base("RegisterAllocationLocalCopyPropagation")
        {
        }
